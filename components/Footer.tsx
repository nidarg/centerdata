    ...
    <footer className="bg-transparent text-neutral-900 dark:text-white text-sm border-t border-gray-500 mt-20 py-6">
      <div className="container grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-x-10 gap-y-6 text-left items-start">
        ...
        <div className="space-y-2 h-full flex flex-col">
          <h2 className="text-lg font-semibold text-goldish">{t('company.name')}</h2>
        ...
        {/* Column 2: Services */}
        <div className="space-y-2 h-full flex flex-col">
          <h2 className="text-lg font-semibold text-goldish">{t('services.title')}</h2>
        ...
        {/* Column 4: Insurance */}
        <div className="space-y-2 h-full flex flex-col">
          <h2 className="text-lg font-semibold text-goldish">{t('insurance.title')}</h2>
        ...
        {/* Column 5: Legal */}
        <div className="space-y-2 h-full flex flex-col">
          <h2 className="text-lg font-semibold text-goldish">{t('legal.title')}</h2>
          <ul className="space-y-2">
            <li>
        ...
        {/* Column 6: Meet CEO */}
        <div className="space-y-2 h-full flex flex-col">
          <h2 className="text-lg font-semibold text-goldish">{t('ceo.title')}</h2>
          <ul className="space-y-2">
            <li>

...
export const TextImage: React.FC<ResponsiveTextImageProps> = ({
  ...
  const altText = imageAlt || title || (Array.isArray(text) ? text.join(', ') : text);
  ...
  return (
    ...
    >
      ...
      {/* Text container */}
      <motion.div
        className={`flex flex-col justify-center w-full lg:w-1/2 text-center md:text-left text-neutral-600 dark:text-white p-4 leading-relaxed h-fit min-h-96 sm:h-96 lg:h-[450px] bg-background dark:bg-neutral-900 shadow-md shadow-slate-900 ${
          reverse

  ...
  return (
    <nav className='fixed top-0 left-0 right-0 z-50 w-full bg-gradient-nav min-h-[128px]'>
      <div className='container flex justify-between items-center px-4'>
        {/* Logo */}
        <div className={`relative transition-all duration-300 ${scrolled ? 'w-[200px] top-2 md:-top-10' : 'w-[300px] top-1 md:-top-16'}`}>
        ...
        <div 
          ref={menuRef} 
          className={`${menuOpen ? 'flex' : 'hidden'} flex-col sm:flex-row sm:flex items-center sm:gap-4 absolute sm:static top-24 left-0 right-0 sm:top-auto bg-background sm:bg-transparent shadow-md sm:shadow-none sm:py-0 py-4`}
        >

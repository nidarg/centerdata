  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      {/* SEO Essentials */}
        ...
        {/* Open Graph Tags */}
        <meta property="og:title" content="Nordic Data Compliance Center | GDPR & Data Privacy Consulting Services" />
        <meta property="og:description" content="Expert data compliance consulting services, including GDPR solutions, tailored for startups and SMEs." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.datacompliancecentre.com" />
        <meta property="og:image" content="/og-image.jpg" /> {/* Replace with actual image path */}
        {/* Twitter Card Tags */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Nordic Data Compliance Center" />
        <meta name="twitter:description" content="Expert GDPR & data privacy consulting services." />
        <meta name="twitter:image" content="/logoImages/9.png" />
        {/* Regional Metadata (optional) */}
        <meta name="geo.region" content="EU" />
        <meta name="geo.placename" content="Denmark" />
        <meta name="ICBM" content="55.6761,12.5683" />
        <link rel="shortcut icon" href="favicon.ico" type="image/x-icon"></link>
        {/* Preconnect for performance (example for Google Fonts) */}
        <link rel="preconnect" href="https://fonts.googleapis.com" />
        <link rel="preconnect" href="https://fonts.gstatic.com" crossOrigin="anonymous" />
        {/* Canonical tag dynamically added */}
        <link
          rel="canonical"
          href={`https://www.datacompliancecentre.com`}
        />
        <Script
          id="CookieConsent"

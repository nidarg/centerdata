  ...
  return (
    <>
      ...
      <Head>
        <meta
          name='description'
          content='Want to get in touch? Feel free to reach out to us with any inquiries, concerns, or assistance you may require.'
        />
        <meta
          name='keywords'
          content='contact, get in touch, inquiry, support, company, help, business inquiries'
        />
        <meta name='author' content='Data Compliance Centre' />
        <link
          rel='canonical'
          href='https://www.datacompliancecentre.com/contact'
        />
        <meta
          property='og:title'
          content='Contact Us | Data Compliance Centre'
        />
        <meta
          property='og:description'
          content='Feel free to reach out to us for any inquiries, assistance, or feedback. Our team is ready to help you.'
        />
        <meta
          property='og:url'
          content='https://www.datacompliancecentre.com/contact'
        />
        ...
        <meta
          ...
          content="Contact us today for any business inquiries or assistance. We're here to help!"
        />
